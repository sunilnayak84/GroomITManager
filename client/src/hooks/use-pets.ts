    ...
    mutationFn: async (petData: PetInput) => {
      try {
        ...
        const newPetData = {
          ...
          temperamentCategory: petData.temperamentCategory || null,
          temperamentTags: petData.temperamentTags || [],
          temperamentNotes: petData.temperamentNotes || null,
          image: imageUrl,
          submissionId,
          createdAt: timestamp,
          updatedAt: null,
        ...
        const firestoreData: WithFieldValue<DocumentData> = {
          ...
          temperamentCategory: newPetData.temperamentCategory,
          temperamentTags: newPetData.temperamentTags,
          temperamentNotes: newPetData.temperamentNotes,
