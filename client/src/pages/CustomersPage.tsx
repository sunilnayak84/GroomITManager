      ...
      <div className="rounded-xl border bg-white shadow-sm overflow-hidden">
        {customersQuery.isLoading ? (
          ...
          <div className="p-1">
            <DataTable
              columns={columns}
              data={(customersData as Customer[]).filter(customer => {
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const typedPet: Pet = {
                          ...
                          temperamentCategory: pet.temperamentCategory as Pet['temperamentCategory'] || null,
                          temperamentTags: pet.temperamentTags || [],
                          temperamentNotes: pet.temperamentNotes ? String(pet.temperamentNotes) : null,
